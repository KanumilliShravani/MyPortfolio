...
const projectList = [
    {
        ...
        "description":"My portfoilo website is a front-end project built using reactjs and css",
         "link":""
    },
    {
        "id": 2,
            ...
            <ul className='project-list-card'>
                {projectList.map(each => 
                    ...
                    <li className='project-list-container' key={each.id}>
                        ...
                        <p className='project-desc'>{each.description} </p>
                        <button type="button" className='visit-btn'><a className='nav-link' href={each.link}>View</a></button>
                    </li>
                    )
                )}
